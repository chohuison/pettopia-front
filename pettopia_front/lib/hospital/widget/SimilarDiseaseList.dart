          ...
          children: <Widget>[
            ...
            Container(
              ...
              children: <Widget>[
                ...
                _Row("생활 환경: ", widget.diseaseValue['environment'], "", ""),
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Text(overflow: TextOverflow.ellipsis, value1),
            ],
          ),
        ),
        SizedBox(width: 20.w),
        Row(
          children: [
            ...
            Text(overflow: TextOverflow.ellipsis, value2),
          ],
        ),
      ],
    );
    ...
    return Row(children: [
      ...
      Column(
        ...
        children: <Widget>[
          ...
          Text(overflow: TextOverflow.ellipsis, value),
        ],
      ),
    ]);
  }

...
class ShortRecordBar extends StatefulWidget {
  ...
  const ShortRecordBar({Key? key, required this.indexNum,required this.index}) : super(key: key);

  @override
  _ShortRecordBarState createState() => _ShortRecordBarState();
}

class _ShortRecordBarState extends State<ShortRecordBar> with AutomaticKeepAliveClientMixin {
  @override

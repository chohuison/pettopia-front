...
class BeautyMapSearch extends StatefulWidget {
  const BeautyMapSearch({Key? key}) : super(key: key);

  @override
  _BeautyMapSearchState createState() => _BeautyMapSearchState();
}

class _BeautyMapSearchState extends State<BeautyMapSearch>
  ...
  void _fetchHospitalList(String selectedRegion) async {
    ...
    List<Map<String, dynamic>> list =  await _apiServer.getBeautyService(selectedRegion);
    setState(() {
     _hospitalList = list;
    });
  }
